...
public class e {
    ...
    public static String a(List<? extends com.uzmap.pkg.ui.b.dd.f> parameters, String encoding) {
        StringBuilder result = new StringBuilder();
        Iterator var4 = parameters.iterator();

        while (var4.hasNext()) {
            com.uzmap.pkg.ui.b.dd.f parameter = (com.uzmap.pkg.ui.b.dd.f) var4.next();
