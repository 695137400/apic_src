...
public class k {
    ...
    private final com.uzmap.pkg.ui.b.a i;
    private final g j;
    private final m k;
    private h[] l;
    private com.uzmap.pkg.ui.b.b m;
    private List<k.b> n;
    ...
    public k(com.uzmap.pkg.ui.b.a cache, g network, int threadPoolSize, m delivery) {
    ...
    public k(com.uzmap.pkg.ui.b.a cache, g network, int threadPoolSize) {
        this(cache, network, threadPoolSize, new f(new Handler(Looper.getMainLooper())));
    }

    public k(com.uzmap.pkg.ui.b.a cache, g network) {
        this(cache, network, h);
    }

    public void a() {
        this.b();
        this.m = new com.uzmap.pkg.ui.b.b(this.d, this.e, this.i, this.k);
        this.m.start();
