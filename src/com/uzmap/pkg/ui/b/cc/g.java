...
public class g implements f {
    ...
    private final com.uzmap.pkg.ui.b.c c;

    public g(com.uzmap.pkg.ui.b.c cookies) {
        this(null, cookies);
    }

    public g(g.a urlRewriter, com.uzmap.pkg.ui.b.c cookies) {
        this(urlRewriter, cookies, null);
    }

    public g(g.a urlRewriter, com.uzmap.pkg.ui.b.c cookies, SSLSocketFactory sslSocketFactory) {
        this.a = urlRewriter;
        this.b = sslSocketFactory;
        this.c = cookies;
    }

    private static com.uzmap.pkg.ui.b.dd.aa.a a(HttpURLConnection connection) {
        com.uzmap.pkg.ui.b.dd.h entity = new com.uzmap.pkg.ui.b.dd.h();
    ...
    static void a(HttpURLConnection connection, com.uzmap.pkg.ui.b.j<?> request) throws IOException, com.uzmap.pkg.ui.b.aa.a {
    ...
    private static void b(HttpURLConnection connection, com.uzmap.pkg.ui.b.j<?> request) throws IOException, com.uzmap.pkg.ui.b.aa.a {
        if (!request.isEmpty()) {
    ...
    public com.uzmap.pkg.ui.b.dd.e a(com.uzmap.pkg.ui.b.j<?> request, Map<String, String> additionalHeaders) throws IOException, com.uzmap.pkg.ui.b.aa.a {
        ...
        if (responseCode == -1) {
            ...
            com.uzmap.pkg.ui.b.dd.e response = new com.uzmap.pkg.ui.b.dd.e(connection.getResponseCode(), connection.getResponseMessage());
    ...
    private HttpURLConnection a(URL url, com.uzmap.pkg.ui.b.j<?> request) throws IOException {
        ...
        if ("https".equals(url.getProtocol())) {
            ...
            ((HttpsURLConnection) connection).setHostnameVerifier(com.uzmap.pkg.ui.b.bb.a.a);
        }
