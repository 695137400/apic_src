...
public class c extends LruCache<String, com.uzmap.pkg.ui.b.dd.c.a1> implements com.uzmap.pkg.ui.b.cc.d.b1 {
    ...
    private class b extends LruCache<String, a1> {
        ...
        public a1 a(String url) {
            if (url != null) {
                String key = com.uzmap.pkg.ui.b.dd.c.d(url);
                return this.get(key);
            } else {
                return null;
            }
                    ...
                    for (int var4 = 0; var4 < var5; ++var4) {
                        ...
                        if (!file.isDirectory()) {
                            ...
                            if (!TextUtils.isEmpty(name)) {
                                ...
                                File thumb = com.uzmap.pkg.ui.b.dd.c.a(file);
                                if (thumb.exists()) {
