...
public class a extends Handler {
   private static com.uzmap.pkg.ui.a.a d;
   private LocationManager locationManager;
   private final Context b;
   private final List<com.uzmap.pkg.ui.a.a.b> c = new ArrayList();

   private a(Context context) {
      this.b = context;
   }

   public static com.uzmap.pkg.ui.a.a a(Context context) {
      if (d == null) {
         d = new com.uzmap.pkg.ui.a.a(context);
      }

      return d;
   }

   public void a(com.uzmap.pkg.ui.a.a.a1 callback) {
      if (this.b != null) {
         this.b(callback);
         int accuracy = 2;
         float filter = 100.0F;
         com.uzmap.pkg.ui.a.a.b listener = this.c(callback);
         if (listener == null) {
            listener = new com.uzmap.pkg.ui.a.a.b(callback, true);
   ...
   public void a(com.uzmap.pkg.ui.a.a.c option, com.uzmap.pkg.ui.a.a.a1 callback) {
      if (this.b != null) {
         ...
         com.uzmap.pkg.ui.a.a.b listener = this.c(callback);
         if (listener == null) {
            listener = new com.uzmap.pkg.ui.a.a.b(callback, option.c);
   ...
   public void b(com.uzmap.pkg.ui.a.a.a1 callback) {
   ...
   private void a(float filter, int accuracy, com.uzmap.pkg.ui.a.a.b listener) throws Exception {
   ...
   private boolean a(com.uzmap.pkg.ui.a.a.b callback) {
      synchronized (this.c) {
   ...
   private com.uzmap.pkg.ui.a.a.b c(com.uzmap.pkg.ui.a.a.a1 callback) {
      synchronized (this.c) {
         Iterator var4 = this.c.iterator();

         while (var4.hasNext()) {
            com.uzmap.pkg.ui.a.a.b listener = (com.uzmap.pkg.ui.a.a.b) var4.next();
   ...
   private void b(com.uzmap.pkg.ui.a.a.b listener) {
      synchronized (this.c) {
         this.c.remove(listener);
      }
   }

   private void a(com.uzmap.pkg.ui.a.a.a1 listener, String msg) {
      if (listener != null) {
   ...
   private class b implements LocationListener, Runnable {
      ...
      private final com.uzmap.pkg.ui.a.a.a1 c;

      public b(com.uzmap.pkg.ui.a.a.a1 listener, boolean autoStop) {
         this.b = autoStop;
         this.c = listener;
      }

      public boolean a(com.uzmap.pkg.ui.a.a.a1 listener) {
