...
public class e {
   ...
   private com.uzmap.pkg.ui.a.e.a b;
   private com.uzmap.pkg.ui.a.e.b c;
   private com.uzmap.pkg.ui.a.e.c d;
   private com.uzmap.pkg.ui.a.e.f e;
   private com.uzmap.pkg.ui.a.e.d f;
   private com.uzmap.pkg.ui.a.e.eSensorEventListener g;
      ...
      if (this.a == null) {
         ...
         switch (type) {
            case 0:
               ...
               this.b = new com.uzmap.pkg.ui.a.e.a(callbackContext);
            ...
            case 1:
               ...
               this.c = new com.uzmap.pkg.ui.a.e.b(callbackContext);
            ...
            case 2:
               ...
               this.d = new com.uzmap.pkg.ui.a.e.c(callbackContext);
            ...
            case 3:
               ...
               this.e = new com.uzmap.pkg.ui.a.e.f(callbackContext);
            ...
            case 4:
               ...
               this.f = new com.uzmap.pkg.ui.a.e.d(callbackContext);
            ...
            case 5:
               ...
               this.g = new com.uzmap.pkg.ui.a.e.eSensorEventListener(callbackContext);
   ...
   private class d implements SensorEventListener {
      ...
      public void onSensorChanged(SensorEvent event) {
         ...
         try {
            json.put("x", this.e[0] * -1.0F);
            json.put("y", this.e[1] * -1.0F);
            json.put("z", this.e[2] * -1.0F);
            json.put("proximity", false);
            json.put("status", true);
         } catch (Exception var4) {
            var4.printStackTrace();
   ...
   private class eSensorEventListener implements SensorEventListener {
      private final k b;

      public eSensorEventListener(k callbackContext) {
         this.b = callbackContext;
      }
