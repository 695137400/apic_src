...
public abstract class d extends j<com.uzmap.pkg.a.b.i> implements com.uzmap.pkg.a.b.l.a1 {
    protected RequestCallback a;
    protected l.b<com.uzmap.pkg.a.b.i> b;
    private String c;
    private String d;
    private String e;
    private boolean f;
    ...
    protected l<com.uzmap.pkg.a.b.i> parseNetworkResponse(com.uzmap.pkg.a.b.i response) {
        com.uzmap.pkg.a.b.p.a(" >>>>>> parseNetworkResponse", (Object) null);
        return com.uzmap.pkg.a.b.l.a(response, com.uzmap.pkg.a.b.cc.e.a(response));
    }

    protected void deliverResponse(com.uzmap.pkg.a.b.i response) {
    ...
    protected void deliverProgress(long contentlength, long finishlength) {
        if (this.needReport() && this.a != null) {
            ...
            com.uzmap.pkg.a.b.p.b("percent: " + finishlength + "," + contentlength + "," + percent);
    ...
    public void onErrorResponse(o error) {
        com.uzmap.pkg.a.b.p.a("onErrorResponse", error);
        if (this.shouldCache()) {
            com.uzmap.pkg.a.b.a.a1 entry = this.getCacheEntry();
            if (entry != null) {
                com.uzmap.pkg.a.b.p.c("Request Error, Return will from Cache <<<< ");
                com.uzmap.pkg.a.b.i response = new com.uzmap.pkg.a.b.i(304, entry.a, entry.g, true, error.a());
    ...
    public final SSLSocketFactory getSslSocketFactory() {
        return !TextUtils.isEmpty(this.d) && !TextUtils.isEmpty(this.e) ? com.uzmap.pkg.a.b.bb.b.a(this.d, this.e) : com.uzmap.pkg.a.b.bb.b.a();
    }
    ...
    public void setSyncListener(l.b<com.uzmap.pkg.a.b.i> listener) {
        this.b = listener;
    }
