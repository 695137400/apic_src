...
public class h extends com.uzmap.pkg.a.b.j<Bitmap> {
    ...
    public h(String url, l.b<Bitmap> listener, int maxWidth, int maxHeight, ScaleType scaleType, Config decodeConfig, com.uzmap.pkg.a.b.l.a1 errorListener) {
        super(0, url, errorListener);
        this.setRetryPolicy(new com.uzmap.pkg.a.b.d(10000, 2, 2.0F));
        this.a = listener;
        this.b = decodeConfig;
        this.c = maxWidth;
        this.d = maxHeight;
    ...
    protected l<Bitmap> parseNetworkResponse(com.uzmap.pkg.a.b.i response) {
        synchronized (f) {
            l var10000;
            try {
                var10000 = this.a(response);
            } catch (OutOfMemoryError var4) {
                com.uzmap.pkg.a.b.p.c("Caught OOM for %d byte image, url=%s", response.b.length, this.getUrl());
                return com.uzmap.pkg.a.b.l.a(new com.uzmap.pkg.a.b.aa.e(var4));
            }
    ...
    private l<Bitmap> a(com.uzmap.pkg.a.b.i response) {
        ...
        return bitmap == null ? com.uzmap.pkg.a.b.l.a(new com.uzmap.pkg.a.b.aa.e(response)) : com.uzmap.pkg.a.b.l.a(bitmap, com.uzmap.pkg.a.b.cc.e.a(response));
    }
