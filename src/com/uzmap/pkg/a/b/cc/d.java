...
public class d {
    private final com.uzmap.pkg.a.b.k a;
    private final b1 c;
    ...
    public d(com.uzmap.pkg.a.b.k queue, b1 cache) {
        this.a = queue;
        this.c = cache;
    }
    ...
    public c1 abm(String requestUrl, d1 imageListener, int maxWidth, int maxHeight, ScaleType scaleType) {
        ...
        if (cachedBitmap != null) {
            ...
            if (request != null) {
                ...
                com.uzmap.pkg.a.b.j<Bitmap> newRequest = this.abm(requestUrl, maxWidth, maxHeight, scaleType, cacheKey);
                this.a.a(newRequest);
    ...
    protected com.uzmap.pkg.a.b.j<Bitmap> abm(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, final String cacheKey) {
    ...
    public void abm(com.uzmap.pkg.a.b.j<?> req) {
        this.a.a(req);
    }

    public final com.uzmap.pkg.a.b.dd.c.a1 abm(String url) {
        return this.c.b(url);
    }
    ...
    public interface b1 {
        ...
        com.uzmap.pkg.a.b.dd.c.a1 b(String var1);
    ...
    private class a1 {
        private final com.uzmap.pkg.a.b.j<?> b;
        private final LinkedList<c1> e = new LinkedList();
        private Bitmap c;
        private o d;

        public a1(com.uzmap.pkg.a.b.j<?> request, c1 container) {
            this.b = request;
