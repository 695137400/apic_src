...
public class UZCoreModule extends UZModule {
    ...
    public void closeSlidPane(String args) {
        Runnable action = new Runnable() {
            public void run() {
                m win = UZCoreModule.this.getWindow();
                if (win != null) {
                    win.a(UZCoreModule.this.mWebView);
                }
            }
        };
        this.runOnUiThread(action);
    ...
    public void setFrameGroupAttr(String args) {
        ...
        Runnable action = new Runnable() {
            public void run() {
                m win = UZCoreModule.this.getWindow();
                if (win != null) {
                    win.b(UZCoreModule.this.mWebView, context);
                }
            }
        };
        this.runOnUiThread(action);
    ...
    public void setPrefs(String args) {
        ...
        moduleContext.success((JSONObject)null, true);
    }
    ...
    public void cancelAjax(String args) {
        k moduleContext = new k(args, this.mWebView);
        String tag = moduleContext.optString("tag", (String)null);
    ...
    public void writeFile(String args) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            JSONObject json = this.e.a(path, data, append);
            moduleContext.success(json, true);
        }
    }
    ...
    public void actionSheet(String args) {
        if (this.c == null) {
            ...
            Runnable action = new Runnable() {
                public void run() {
                    UZCoreModule.this.c = new a(UZCoreModule.this.mContext, (Object)null) {
    ...
    public void clearCache(String args) {
        k moduleContext = new k(args, this.mWebView);
        String type = moduleContext.optString("type", (String)null);
        ...
        com.uzmap.pkg.uzcore.uzmodule.internalmodule.a clearaAtion = new com.uzmap.pkg.uzcore.uzmodule.internalmodule.a(id);
    ...
    public void lockSlidPane(String args) {
        Runnable action = new Runnable() {
            public void run() {
                m win = UZCoreModule.this.getWindow();
                if (win != null) {
                    win.a(UZCoreModule.this.mWebView, true);
                }
            }
        };
        this.runOnUiThread(action);
    ...
    public void unlockSlidPane(String args) {
        Runnable action = new Runnable() {
            public void run() {
                m win = UZCoreModule.this.getWindow();
                if (win != null) {
                    win.a(UZCoreModule.this.mWebView, false);
                }
            }
        };
        this.runOnUiThread(action);
    ...
    public void historyBack(String args) {
        ...
        Runnable action = new Runnable() {
            public void run() {
                m win = UZCoreModule.this.getWindow();
                if (win != null) {
                    boolean status = win.a(frameName, UZCoreModule.this.mWebView);
                    JSONObject json = new JSONObject();
    ...
    public void appInstalled(String args) {
        k moduleContext = new k(args, this.mWebView);
        String packageName = moduleContext.optString("appBundle", (String)null);
        boolean exist = false;
        if (packageName != null) {
    ...
    public void requestFocus(String args) {
        k moduleContext = new k(args, this.mWebView);
        final String frameName = moduleContext.optString("name", (String)null);
        Runnable action = new Runnable() {
            public void run() {
                m win = UZCoreModule.this.getWindow();
                if (win != null) {
    ...
    public Object onTvPeak(String args) {
        if (!this.valid()) {
            ...
            if (window != null) {
                boolean handled = window.a(this.mWebView, keyCode);
                if (handled) {
                    return true;
                }
            }
    ...
    public Object setTvFocusElement(String args) {
        if (!this.valid()) {
            ...
            m window = this.getWindow();
            if (window != null) {
                window.a(this.mWebView, moduleContext);
            }
    ...
    public String ES(String jsobject, String jsmethod) {
        if (!this.valid()) {
            ...
            Object result = moduleMgr.a(jsobject, jsmethod, (UZModuleContext)null);
